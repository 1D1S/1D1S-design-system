  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        "rounded-2 h-auto min-w-32 sm:min-w-37.5 items-center gap-0 bg-white px-2.5 py-1.5 sm:px-3 sm:py-2 inset-ring-[1px] inset-ring-gray-400 data-placeholder:text-gray-500 data-[size=default]:h-auto data-[size=sm]:h-auto cursor-pointer",
        className,
      )}
      {...props}
    >
