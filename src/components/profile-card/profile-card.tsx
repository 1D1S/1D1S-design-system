    ...
    >
      ...
      <div className="flex w-full">
        ...
        {shouldRenderContent && (
          ...
          >
            <Label size="body1" weight="medium">
              로그인이 필요해요.
            </Label>
            <Label size="caption2" weight="regular">
              오늘의 목표 ?개
            </Label>
          </div>
        )}
      ...
      {shouldRenderContent && (
        ...
        >
          <Label size="heading2" weight="bold" className="text-main-900">
            ??
          </Label>
          <Label size="heading2" weight="bold">
            일 연속 수행
          </Label>
        </div>
      )}
