 ...
 * @example 기본 사용
 * ```tsx
 * <Label size="body1" weight="bold">텍스트</Label>
 * ```
 *
 * @example HTML 태그 변경
 * ```tsx
 * <Label as="p" size="caption1" weight="regular">단락 텍스트</Label>
 * ```
 */
export function Label({
  ...
  return <Tag className={cn(labelVariants({ size, weight, className }))} {...props} />;
}
